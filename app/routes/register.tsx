...
import { registerUser, createUserSession } from "~/lib/session.server";

export const meta = () => ([
  { title: 'Selectify | Register' },
  { name: 'description', content: 'Create your Selectify account' },
]);
      ...
      <div className="w-full max-w-md mx-auto p-4 animate-in fade-in zoom-in-95 duration-700 relative z-10">
        <section className="flex flex-col gap-6 glass-card p-10 md:p-12 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white mb-0">Create Account</h1>
            <p className="text-slate-400">Join Selectify to supercharge your career.</p>
          </div>
          ...
          <p className="text-slate-500 text-sm">
            ...
            <Link to={`/login?next=${encodeURIComponent(next)}`} className="text-sky-400 hover:text-sky-300 font-medium">
              Sign in →
            </Link>
          </p>
        </section>
